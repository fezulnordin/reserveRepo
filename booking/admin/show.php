	...
	?>
		...
		<article>
			...
			<address >
				...
				<p><br></p>
				<p>Customer Name  : -  <?php echo $title.$Fname;?><br></p>
				<p>Matric Number  : -  <?php echo $Matric;?><br></p>
			</address>
			<table class="meta">
				<tr>
			...
			<table >
					<tr> 
						<td>Contact Number: -  <?php echo $phone; ?> </td>
						
						<td>E-mail Address : -  <?php echo $email; ?> </td>
					</tr>
					<tr> 
						<td>Kulliyyah : -  <?php echo $Kulliyyah; ?> </td>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						<td><span ><?php echo $venue; ?></span></td>
						
						
					</tr>
					<tr>
						<td><span ><?php echo $court; ?></span></td>
